...
urlpatterns = [
    ...
    path("secret/list/", views.ListSecretsAPIView.as_view(), name="list-secrets"),
    ...
    path("api-key/", views.CreateAPIKeyAPIView.as_view(), name="create-api-key"),
    path("api-key/list/", views.ListAPIKeysAPIView.as_view(), name="list-api-keys"),
]
